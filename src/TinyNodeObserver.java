...
public class TinyNodeObserver implements Control
{
	...
	{	
		...
		String blockchain15 = protocol15.publicBlockchain.longestPathToJSON(protocol15.publicBlockchain.head);
		String blockchain223 = protocol223.publicBlockchain.longestPathToJSON(protocol223.publicBlockchain.head);
		...
		if(blockchain15.compareTo(blockchain223) == 0) {
			...
			if(protocol15.publicBlockchain.UTXO.equals(protocol223.publicBlockchain.UTXO))
			...
			System.err.println("15 is \n " + protocol15.publicBlockchain.longestPathToJSON(protocol15.publicBlockchain.head));
			for(int i = 0; i < protocol15.localBlockchain.UTXO.size(); i++)
				System.out.print(protocol15.localBlockchain.UTXO.get(i) + " ");
			System.out.println();
			
			System.err.println("223 is \n " + protocol223.publicBlockchain.longestPathToJSON(protocol223.publicBlockchain.head));
